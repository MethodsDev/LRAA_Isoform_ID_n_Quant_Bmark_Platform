...
#        --analysisType ref_free --truth_gtf ../reference_data/Araport11_GTF_genes_transposons.May2023.pigeon2_cleaned_with_gene.gtf --truth_quant ../reference_data/Arabidopsis_transcript_id_count.tsv
