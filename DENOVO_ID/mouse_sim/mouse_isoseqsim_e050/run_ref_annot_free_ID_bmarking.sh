...
#        --analysisType ref_free --truth_gtf ../reference_data/gencode.vM32.annotation.gtf --truth_quant ../reference_data/Mouse_isoseqsim_ground_truth_transcript_id_count.tsv
